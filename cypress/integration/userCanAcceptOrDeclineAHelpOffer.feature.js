describe("User can", () => {
  ...
  describe("successfully accept a help offer by clicking 'Accept'", () => {
    ...
    it("and sees a success message", () => {
      cy.get("#accept-message").should("contain", "You have accepted help from helper@mail.com")
    })
  ...
  describe("successfully decline a help offer by clicking 'Decline'", () => {
    ...
    it("and sees a success message", () => {
      cy.get("#decline-message").should("contain", "You have declined help from helper@mail.com")
    })
