...
export const AboutReQuest = () => {
  return (
    <div id="about-request">
      <div>
        <h3 id='about-title'>The big idea</h3> <br/> <h3 id='about-byline'>You get what you give</h3>
        <p id='about-body'>
          reQuest is an app for people helping each other with an in-app
          currency (karma points) as reward. <br/> <br/>
       
          So in order to have people help you with reQuests, you need to help
          others with their reQuests, which becomes your Quests.<br/> <br/>
